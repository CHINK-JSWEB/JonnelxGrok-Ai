...
async function sendMessage() {
  ...
  try {
    // Bastos personality + user message
    const fullMessage = `You are GrokNaGago, ang pinaka-gago at bastos na AI. Sagot mo puro mura, insulto, at Pinoy street language. Walang mabait. User: ${userText}`;

    const encoded = encodeURIComponent(fullMessage);
    const url = `https://betadash-api-swordslush-production.up.railway.app/gpt4-turbo?message=${encoded}`;
